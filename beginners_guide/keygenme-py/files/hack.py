...
def check_key(key, username_trial):
    ...
    if len(key) != len(key_full_template_trial):
        ...
        print(f"Contents of hash: {hashlib.sha256(username_trial).hexdigest()[6]}")
        print(f"Contents of hash: {hashlib.sha256(username_trial).hexdigest()[2]}")
        print(f"Contents of hash: {hashlib.sha256(username_trial).hexdigest()[7]}")
        print(f"Contents of hash: {hashlib.sha256(username_trial).hexdigest()[1]}")
        print(f"Contents of hash: {hashlib.sha256(username_trial).hexdigest()[8]}")
